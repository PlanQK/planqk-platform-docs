...
1. First, you need to download or generate the PlanQK user code template as explained in the [documentation](../managed-services/introduction.md).
2. Implement your service logic by modifying the PlanQK user code template according to your business requirements.
3. Before deploying it to the PlanQK platform, you should test the correct behaviour of your service on your local machine.
...
To interact with organizations we first have to [create one](../manage-organizations.md).

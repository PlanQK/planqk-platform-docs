# Report usage of your external service
...
## Prerequisites
- You have already created your external service on our platform.
- You have created a personal access token with the `api` scope. 

## 1. Create a pay-per-use pricing plan for your service
...
## 2. Report product usage of your external service
::: tip Authentication

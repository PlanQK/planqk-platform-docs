...
| Runtime Configuration  | PlanQK supports to run your service based on the PlanQK Coding Template and custom Docker containers following PlanQK's runtime interface. Choose "Python Template" for selecting the PlanQK Coding Template as your baseline.                                                                                                                                                                                                         |
